--[[--------------------------------------------------------------------
  MiniGM teleport database    1306 locations / 143 zones / 8 groups

  Shape:  MiniGMTele[group][zone][location] = ".go xyz X Y Z MapID"
  The value IS the finished GM command - sent verbatim, nothing is parsed
  at runtime. `.go xyz` moves YOU only; target/party/raid send this first
  and then `.summon <name>` per member.

  MiniGMTeleOrder fixes the group display order (Lua pairs() is random).

  DERIVED WORK - see LICENSE and README.md.
  Coordinates come from AzerothAdmin's Data/TeleportTable.lua
  (SuperStyro Dev team + Manground Dev Team, GPLv3), which derives from
  TrinityAdmin and MangAdmin. Regrouped from AzerothAdmin's 12 branches
  into 8, and 7 corrupt coordinate strings were repaired:
    Burning Steppes            Ruins of Thaurissan                133.010.437 -> 133.010437 (stray period)
    Azshara                    The Shattered Strand               z truncated, map id missing -> Kalimdor (1)
    Desolace                   Sar'theris Strand                  command prefix duplicated
    Durotar                    Deadeye Shore                      map id missing -> Kalimdor (1)
    The Barrens                Fray Island                        -4325,567383 -> comma to period
    The Barrens                Razorfen Downs Entrance            -2110/74385 -> slash to period
    Blade's Edge Mountains     Bash'ir Landing                    x double-pasted: 3751.623751.620117
  Generated - do not hand-edit; regenerate from the source table instead.
----------------------------------------------------------------------]]
...
MiniGMTele = {
  ["Eastern Kingdoms"] = {
    ...
    ["Burning Steppes"] = {
      ...
      ["Ruins of Thaurissan"] = ".go xyz -7798.315430 -2171.406982 133.010437 0",
  ...
  ["Kalimdor"] = {
    ...
    ["Azshara"] = {
      ...
      ["The Shattered Strand"] = ".go xyz 4266.963379 -6277.396973 92.900871 1",
    ...
    ["Desolace"] = {
      ...
      ["Sar'theris Strand"] = ".go xyz -628.915649 2563.067627 34.792370 1",
    ...
    ["Durotar"] = {
      ...
      ["Deadeye Shore"] = ".go xyz 918.715027 -5115.689941 -1.654380 1",
    ...
    ["The Barrens"] = {
      ...
      ["Razorfen Downs Entrance"] = ".go xyz -4323.557129 -2110.743850 77.923454 1",
  ...
  ["Outland"] = {
    ["Blade's Edge Mountains"] = {
      ["Bash'ir Landing"] = ".go xyz 3751.620117 6129.130000 266.810547 530",
